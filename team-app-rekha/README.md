...
[Go to Demo](https://team-app-rekha.herokuapp.com/) and create your own account or use `username: t@test.com` and `password: test123`. The demo is hosted on Heroku using their free tier. Thus, it may take 20-30 seconds for the Heroku dyno to wake up since it sleeps after 30 minutes of inactivity.
